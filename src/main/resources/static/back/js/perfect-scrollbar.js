!function (t, e) {
    var r = function (t) {
        ...
        225: function (t, e, r) {
            ...
            t.exports = function () {
                ...
                function c(t, e) {
                    var r = t.element.classList, i = s.state.scrolling(e);
                ...
                f.prototype.eventElement = function (t) {
                    ...
                    var i = this.eventElement(t), l = function (t) {
                        i.unbind(e, l), r(t)
                    };
                    i.bind(e, l)
                };
                var b = function (t, e, r, i, l) {
                    var n;
                    if (void 0 === i && (i = !0), void 0 === l && (l = !1), "top" === e) n = ["contentHeight", "containerHeight", "scrollTop", "y", "up", "down"]; else {
                        if ("left" !== e) throw new Error("A proper axis should be provided");
                        n = ["contentWidth", "containerWidth", "scrollLeft", "x", "left", "right"]
                    }
                    !function (t, e, r, i, l) {
                        var n = r[0], o = r[1], s = r[2], a = r[3], u = r[4], d = r[5];
                        void 0 === i && (i = !0), void 0 === l && (l = !1);
                        var f = t.element;
                        t.reach[a] = null, f[s] < 1 && (t.reach[a] = "start"), f[s] > t[n] - t[o] - 1 && (t.reach[a] = "end"), e && (f.dispatchEvent(p("ps-scroll-" + a)), e < 0 ? f.dispatchEvent(p("ps-scroll-" + u)) : e > 0 && f.dispatchEvent(p("ps-scroll-" + d)), i && function (t, e) {
                            c(t, e), h(t, e)
                        }(t, a)), t.reach[a] && (e || l) && f.dispatchEvent(p("ps-" + a + "-reach-" + t.reach[a]))
                    }(t, r, n, i, l)
                };
                ...
                var v = {
                    ...
                    t.containerWidth = r.clientWidth, t.containerHeight = r.clientHeight, t.contentWidth = r.scrollWidth, t.contentHeight = r.scrollHeight, r.contains(t.scrollbarXRail) || (o(r, s.element.rail("x")).forEach(function (t) {
                        ...
                        }), e(r.scrollbarY, {top: r.scrollbarYTop, height: r.scrollbarYHeight - r.railBorderYWidth})
                ...
                function w(t, e) {
                    var r = e[0], i = e[1], l = e[2], n = e[3], o = e[4], s = e[5], a = e[6], u = e[7], d = t.element,
                        f = null, p = null, b = null;

                    function g(e) {
                        d[a] = f + b * (e[l] - p), c(t, u), m(t), e.stopPropagation(), e.preventDefault()
                    }
                    ...
                    t.event.bind(t[o], "mousedown", function (e) {
                        f = d[a], p = e[l], b = (t[i] - t[r]) / (t[n] - t[s]), t.event.bind(t.ownerDocument, "mousemove", g), t.event.once(t.ownerDocument, "mouseup", v), e.stopPropagation(), e.preventDefault()
                    })
                }
                ...
                var X = {
                    "click-rail": function (t) {
                        ...
                        w(t, ["containerWidth", "contentWidth", "pageX", "railXWidth", "scrollbarX", "scrollbarXWidth", "scrollLeft", "x"]), w(t, ["containerHeight", "contentHeight", "pageY", "railYHeight", "scrollbarY", "scrollbarYHeight", "scrollTop", "y"])
                    }, keyboard: function (t) {
                        var e = t.element;
                        t.event.bind(t.ownerDocument, "keydown", function (r) {
                            if (!(r.isDefaultPrevented && r.isDefaultPrevented() || r.defaultPrevented) && (l(e, ":hover") || l(t.scrollbarX, ":focus") || l(t.scrollbarY, ":focus"))) {
                                var i,
                                    n = document.activeElement ? document.activeElement : t.ownerDocument.activeElement;
                                if (n) {
                                    if ("IFRAME" === n.tagName) n = n.contentDocument.activeElement; else for (; n.shadowRoot;) n = n.shadowRoot.activeElement;
                                    if (l(i = n, "input,[contenteditable]") || l(i, "select,[contenteditable]") || l(i, "textarea,[contenteditable]") || l(i, "button,[contenteditable]")) return
                                }
                                var o = 0, s = 0;
                                switch (r.which) {
                                    case 37:
                                ...
                                t.settings.suppressScrollX && 0 !== o || t.settings.suppressScrollY && 0 !== s || (e.scrollTop -= s, e.scrollLeft += o, m(t), function (r, i) {
                                    var l = e.scrollTop;
                                    if (0 === r) {
                                        if (!t.scrollbarYActive) return !1;
                                        if (0 === l && i > 0 || l >= t.contentHeight - t.containerHeight && i < 0) return !t.settings.wheelPropagation
                                    }
                                    var n = e.scrollLeft;
                                    if (0 === i) {
                                        if (!t.scrollbarXActive) return !1;
                                        if (0 === n && r < 0 || n >= t.contentWidth - t.containerWidth && r > 0) return !t.settings.wheelPropagation
                                    }
                                    return !0
                        ...
                        function i(i) {
                            ...
                            if (!function (e, i, l) {
                                ...
                                for (var n = e; n && n !== r;) {
                                    ...
                                    var o = t(n), a = [o.overflow, o.overflowX, o.overflowY].join("");
                                    if (a.match(/(scroll|auto)/)) {
                                        var c = n.scrollHeight - n.clientHeight;
                                        if (c > 0 && !(0 === n.scrollTop && l > 0 || n.scrollTop === c && l < 0)) return !0;
                                        var h = n.scrollLeft - n.clientWidth;
                                        if (h > 0 && !(0 === n.scrollLeft && i < 0 || n.scrollLeft === h && i > 0)) return !0
                                    }
                                    n = n.parentNode
                                }
                                return !1
                                ...
                                var a = !1;
                                e.settings.useBothWheelAxes ? e.scrollbarYActive && !e.scrollbarXActive ? (o ? r.scrollTop -= o * e.settings.wheelSpeed : r.scrollTop += n * e.settings.wheelSpeed, a = !0) : e.scrollbarXActive && !e.scrollbarYActive && (n ? r.scrollLeft += n * e.settings.wheelSpeed : r.scrollLeft -= o * e.settings.wheelSpeed, a = !0) : (r.scrollTop -= o * e.settings.wheelSpeed, r.scrollLeft += n * e.settings.wheelSpeed), m(e), (a = a || function (t, i) {
                                    var l = 0 === r.scrollTop, n = r.scrollTop + r.offsetHeight === r.scrollHeight,
                                        o = 0 === r.scrollLeft, s = r.scrollLeft + r.offsetWidth === r.offsetWidth;
                                    return !(Math.abs(i) > Math.abs(t) ? l || n : o || s) || !e.settings.wheelPropagation
                        ...
                        if (v.supportsTouch || v.supportsIePointer) {
                            var r = e.element, i = {}, l = 0, n = {}, o = null;
                        ...
                        function u(t) {
                            if (h(t)) {
                                var e = c(t);
                                i.pageX = e.pageX, i.pageY = e.pageY, l = (new Date).getTime(), null !== o && clearInterval(o)
                            }
                        }

                        function d(o) {
                            if (h(o)) {
                                var u = c(o), d = {pageX: u.pageX, pageY: u.pageY}, f = d.pageX - i.pageX,
                                    p = d.pageY - i.pageY;
                                if (function (e, i, l) {
                                    if (!r.contains(e)) return !1;
                                    for (var n = e; n && n !== r;) {
                                ...
                                a(f, p), i = d;
                                var b = (new Date).getTime(), g = b - l;
                                g > 0 && (n.x = f / g, n.y = p / g, l = b), function (t, i) {
                                    var l = r.scrollTop, n = r.scrollLeft, o = Math.abs(t), s = Math.abs(i);
                                    if (s > o) {
                                        if (i < 0 && l === e.contentHeight - e.containerHeight || i > 0 && 0 === l) return 0 === window.scrollY && i > 0 && v.isChrome
                    ...
                    var n = this;
                    if (void 0 === l && (l = {}), "string" == typeof i && (i = document.querySelector(i)), !i || !i.nodeName) throw new Error("no element is specified to initialize PerfectScrollbar");
                    ...
                    this.isRtl = "rtl" === t(i).direction, this.isNegativeScroll = (a = i.scrollLeft, c = null, i.scrollLeft = -1, c = i.scrollLeft < 0, i.scrollLeft = a, c), this.negativeScrollAdjustment = this.isNegativeScroll ? i.scrollWidth - i.clientWidth : 0, this.event = new f, this.ownerDocument = i.ownerDocument || document, this.scrollbarXRail = r(s.element.rail("x")), i.appendChild(this.scrollbarXRail), this.scrollbarX = r(s.element.thumb("x")), this.scrollbarXRail.appendChild(this.scrollbarX), this.scrollbarX.setAttribute("tabindex", 0), this.event.bind(this.scrollbarX, "focus", h), this.event.bind(this.scrollbarX, "blur", u), this.scrollbarXActive = null, this.scrollbarXWidth = null, this.scrollbarXLeft = null;
                    ...
                    this.scrollbarYRight = parseInt(p.right, 10), isNaN(this.scrollbarYRight) ? (this.isScrollbarYUsingRight = !1, this.scrollbarYLeft = g(p.left)) : this.isScrollbarYUsingRight = !0, this.scrollbarYOuterWidth = this.isRtl ? function (e) {
                    ...
                    }(this.scrollbarY) : null, this.railBorderYWidth = g(p.borderTopWidth) + g(p.borderBottomWidth), e(this.scrollbarYRail, {display: "block"}), this.railYMarginHeight = g(p.marginTop) + g(p.marginBottom), e(this.scrollbarYRail, {display: ""}), this.railYHeight = null, this.railYRatio = null, this.reach = {
                        ...
                        return X[t](n)
                    }), this.lastScrollTop = i.scrollTop, this.lastScrollLeft = i.scrollLeft, this.event.bind(this.element, "scroll", function (t) {
                        return n.onScroll(t)
                    }), m(this)
                };
                return y.prototype.update = function () {
                    ...
                    this.isAlive && (m(this), b(this, "top", this.element.scrollTop - this.lastScrollTop), b(this, "left", this.element.scrollLeft - this.lastScrollLeft), this.lastScrollTop = this.element.scrollTop, this.lastScrollLeft = this.element.scrollLeft)
            ...
            "use strict";
            Object.defineProperty(e, "__esModule", {value: !0}), e.PerfectScrollbar = void 0;
            var i, l = r(225), n = (i = l) && i.__esModule ? i : {default: i};
    ...
    if ("object" == typeof r) {
        ...
        for (var l in r) i[0] && (i[0][l] = r[l]), i[1] && "__esModule" !== l && (i[1][l] = r[l]), i[2] && (i[2][l] = r[l])
    }
}(this);